            ...
            ColumnLayout {
                ...
                Repeater {
                    ...
                    delegate: ItemDelegate {
                        ...
                        background: Rectangle {
                            color: highlighted ? appColors.primary : "transparent"
        ...
        Rectangle {
            ...
            Column {
                ...
                Row {
                    ...
                    Repeater {
                        model: [
                            { title: "Ventas Hoy", value: "Bs. 2,450", icon: "💰", color: appColors.success },
                            { title: "Productos", value: "156", icon: "📦", color: appColors.primary },
                            { title: "Pedidos", value: "23", icon: "🛒", color: appColors.warning },
                            { title: "Ingresos Mes", value: "Bs. 45,200", icon: "📈", color: appColors.primaryDark }
                        ]
            ...
            Rectangle {
                ...
                border.color: "#E0E0E0"
                border.width: 1
                visible: currentView !== "dashboard" && currentView !== "reports"
